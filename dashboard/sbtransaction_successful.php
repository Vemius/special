  ...
  <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
    ...
    <hr class="horizontal dark mt-0 mb-6">
     ...
     <div class="col-xl-12">
         ...
         <p>You have successfully Transferred <?php echo $row['currency']?><?php echo $rows['amount']?></p>
...
<div id="myModal" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
          ...
          <br>
          <h5 style="color:#114e11;">You have successfully Transferred.</h5>
          ...
          <h5 style="color:#114e11;">Beneficiary Account No.:&nbsp;&nbsp;<?php echo $rows['acc_no']?></h5>
                ...
                <br>
                <p style="text-align:center;color:red;font-size: 15px;"><strong>SECURITY TIPS</strong></p>
                <p style="text-align:justify;color:red;font-size: 15px;">Do not share your credentials  with anyone.<br>We will never ask you for your password, PIN, or OTP codes. <br>Always report suspicious emails to fraud@domain.com</p>
<br>
                <form>
