                    ...
                    <div class="col-lg-6">
                     ...
                     <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" id="input-first-name" class="form-control form-control-alternative" name="transtype" readonly  value="InterBank" >
                      </div>
                    </div>
                  </div>
                  
                  
                <input class="form-control" placeholder="Bank Name" name="bank_name" value="<?php echo $row['bank_name']; ?> " type="text" hidden>
