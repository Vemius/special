      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="navbar col-lg-12 col-12 p-lg-0 fixed-top d-flex flex-row" >
          <div class="navbar-menu-wrapper d-flex align-items-stretch justify-content-between" style="background-color:<?php echo $digital_forest_script_header; ?>; color:<?php echo $digital_forest_script_header_font; ?>;">
            ...
            <ul class="navbar-nav navbar-nav-right ml-lg-auto">
              ...
              <li class="nav-item nav-profile dropdown border-0">
                <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-toggle="dropdown">
                  <img class="nav-profile-img mr-2" alt="" src="admin/pic/<?php echo $row['uname']; ?>.jpg" alt="profile" />
