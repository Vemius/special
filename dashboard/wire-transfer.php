...
if(isset($_POST['transfer'])){
	...
	$stmt = $reg_user->runQuery("SELECT * FROM temp_transfer WHERE email=:email");
    ...
    if ($stmt->rowCount() > 0 ) {
        $msg = "
								<div class='alert alert-danger text-white w-70' fade='' in='' alert-dismissible=''>		     
		      ...
		      <script type='text/javascript'>
				...
				<a href='#' class='close2 mx-2' data-dismiss='alert' aria-label='close'>&times;</a>
					<strong>Sorry!  You have a Pending Transaction on A/C: $acc_no Please Complete the Transaction before a new transfer will be initiated  Redirecting.....</strong> 
			  </div>
			  ";
    } else {
	...
	$msg1 = "
					...
					<center>	<strong style='color:black;'>Please Wait! &nbsp;  We are Validating your Wire Transfer information 
                           </strong></center>
			  		</div>
					";
 ...
 <body onload="myFunction()" class="g-sidenav-show bg-gray-100">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="make_tranfers.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center"><svg>
                <i class="color fa fa-send text-lg me-1"></i>                <title>spaceship</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          ...
          <div class="collapse show" id="dashboardsExamples" style="">
            ...
            <li class="nav-item ">
                <a class="nav-link " href="samebank_transfer.php">
    ...
    width: 20px;"> <?php echo $site_initial; ?> account </span>
              ...
              <li class="nav-item active">
                <a class="nav-link active" href="international_transfer.php">
...
<div class="container-fluid py-4">
      <div class="row">
        <div class="col-lg-8 mx-auto">
          <div class="">
            ...
            <div class="card-body">
                <p><strong>International Transfer to:</strong> </p>               <div class="col-4 text-right mt-3">
                  <a href="contact_support.php" class="btn btn-danger">Need Help?</a>
                </div>
                ...
                <div class="pl-lg-4">
                  ...
                  <div class="row">
                   ...
                   <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label text-sm" for="input-first-name">Select Country</label>
   ...
   <option value="Zimbabwe">Zimbabwe</option>
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label text-sm" for="input-last-name">Swift Code</label>
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label text-sm" for="input-first-name">Routing Number</label>
                        <input class="form-control" placeholder="Routing Num." name="routing" type="number" value="none" required>
                      </div>
                    </div>
                     <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label text-sm" for="input-first-name">Transaction Type</label>
                        <input class="form-control" placeholder="" name="transtype" type="text" value="REF-WIRE-DEB-<?php echo(rand(1000, 9999)); ?>"  readonly="true"  required>
                      </div>
                    </div>
                  </div>
