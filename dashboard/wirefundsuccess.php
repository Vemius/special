    ...
    <div class="container-fluid mt--7">
     ...
     <div class="row">
        ...
        <div class="col-xl-8 order-xl-1"><br><br>
          ...
          <br>
          <h4 style="color:green;">    You have successfully Transferred <?php echo $row['currency']?><?php echo $rows['amount']?> to Account Number <?php echo $rows['acc_no']?> Belonging to <?php echo $rows['acc_name']?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
          ...
          <h5 style="color:#114e11;">Beneficiary Account No.:&nbsp;&nbsp;<?php echo $rows['acc_no']?></h5>
                ...
                <br>
                <p style="text-align:justify;color:#a3a5a5;font-size: 15px;">International transaction initiated successfully, </br>it will take 2-3 working days to credit funds in receivers account.<br>
