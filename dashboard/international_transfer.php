      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="statement.php">
            ...
            <i class="fa fa-bar-chart text-dark text-lg me-1"></i> 
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <li class="nav-item">
        <a data-bs-toggle="collapse" href="#dashboardsExamples" class="nav-link active" href="make_transfer.php" aria-controls="dashboardsExamples" role="button" aria-expanded="true">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center"><svg>
                <i class="color fa fa-send text-dark text-lg me-1"></i>                <title>spaceship</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <li class="nav-item ">
                <a class="nav-link nav-link <?php echo (basename($_SERVER['PHP_SELF']) == "samebank_transfer.php")?"active":"";?>" href="samebank_transfer.php">
                  <span class="sidenav-mini-icon" ></span>
                  <span class=""><img src="<?php echo $site_online; ?>/assets/img/favicon.png" style="
    width: 20px;"> <?php echo $site_initial; ?> account </span>
                </a>
              </li>
              <li class="nav-item ">
                <a class="nav-link nav-link <?php echo (basename($_SERVER['PHP_SELF']) == "other_transfer.php")?"active":"";?>" href="other_transfer.php">
                  <span class="sidenav-mini-icon"> D </span>
                  <span class="sidenav-normal"> Other Banks</span>
                </a>
              </li>
              <li class="nav-item ">
                <a class="nav-link nav-link nav-link <?php echo (basename($_SERVER['PHP_SELF']) == "international_transfer.php")?"active":"";?>" href="international_transfer.php">
      ...
      <div class="row">
        <div class="col-lg-8 mx-auto">
          <div class="">
            ...
            <div class="card-body">
                <p>Send money to international <strong>Beneficiaries</strong>.</p>
                ...
                <div class="pl-lg-4">
                  ...
                  <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        <label class="form-control-label text-sm" for="input-username">Amount (<?php echo $row['currency']; ?>)</label>
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label text-sm" for="input-email">Beneficiary Account Name</label>
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label text-sm" for="input-first-name">Beneficiary Account Number</label>
                        <input type="number" id="input-first-name" class="form-control form-control-alternative"  placeholder="Beneficiary Account Number" name="acc_no" type="number" required>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label text-sm" for="input-last-name">Bank Name</label>
                    ...
                    <input class="form-control" placeholder="Swiftcode" name="transtype" type="hidden" value="WIRE-DEB" required>
                  
                  
                   <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label text-sm text-sm" for="input-first-name">Select Country</label>
...
<option value="Afganistan">Afghanistan</option>
   ...
   <option value="Zimbabwe">Zimbabwe</option>
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label text-sm text-sm" for="input-last-name">Swift Code</label>
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label text-sm text-sm" for="input-first-name">Routing Number</label>
                        <input class="form-control" placeholder="Routing Num." name="routing" type="number" value="none" >
                      </div>
                    </div>
                   ...
                   <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label text-sm text-sm" for="input-first-name">Narration/Purpose</label>
  ...
  <!-- Address -->
                ...
                <div class="pl-lg-4">
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                          <button class="btn btn-warning" type="submit" name="transfer"><i class="fa fa-send text-white text-lg me-3"></i>  Make Transfer</button>
                      </div>
                    </div>
                  </div>
