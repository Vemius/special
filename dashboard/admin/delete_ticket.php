...
if(isset($_POST['btn-del']))
{
	$id = $_GET['delete_id'];
	$crud->deletetik($id);
	header("Location: delete_ticket.php?deleted");	
}
...
if(isset($_GET['delete_id']))
{
    ...
    <a href="ticket.php" class="btn btn-large btn-success"><i class="glyphicon glyphicon-backward"></i> &nbsp; NO</a>
    </form>  
	<?php
}
else
{
	?>
    <a href="ticket.php" class="btn btn-large btn-success"><i class="glyphicon glyphicon-backward"></i> &nbsp; Back to index</a>
    <?php
}
?>
