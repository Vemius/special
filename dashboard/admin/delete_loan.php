...
if(isset($_POST['btn-del']))
{
	$id = $_GET['delete_id'];
	$crud->deletel($id);
	header("Location: delete_loan.php?deleted");	
}
...
if(isset($_GET['delete_id']))
{
    ...
    <a href="loanrequest.php" class="btn btn-large btn-success"><i class="glyphicon glyphicon-backward"></i> &nbsp; NO</a>
    </form>  
	<?php
}
else
{
	?>
    <a href="loanrequest.php" class="btn btn-large btn-success"><i class="glyphicon glyphicon-backward"></i> &nbsp; Back to index</a>
    <?php
}
?>
