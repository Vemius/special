        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link " href="new_account.php">
              <i class="fa fa-user-plus" aria-hidden="true" style='font-size:18px;color:black'></i> Add New User
            </a>
          </li>
            ...
            <i class="fa fa-user-circle-o" aria-hidden="true" style='font-size:18px;color:black'></i>View Users Account
            </a>
          </li>
          
          
             <li class="nav-item">
            <a class="nav-link " href="userpins.php">
            <i class="fa fa-user-circle-o" aria-hidden="true" style='font-size:18px;color:black'></i>View Users pins
            </a>
          </li>
            ...
            <a class="nav-link " href="update.php">
                 <i class="fa fa-pencil-square-o" aria-hidden="true" style='font-size:18px;color:black'></i>Update User
            </a>
          </li>
            
                 <li class="nav-item">
            <a class="nav-link " href="upload.php">
               <i class="fa fa-picture-o" aria-hidden="true" style='font-size:18px;color:black'></i>Update User image
            </a>
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link " href="credit_debit_list.php">
                <i class="fa fa-exchange" aria-hidden="true" style='font-size:18px;color:black'></i> Transfer Status
            </a>
          </li>
           ...
           <li class="nav-item">
            ...
            <a class="nav-link " href="debit.php">
             ...
             <li class="nav-item">
            <a class="nav-link " href="wire_transfer.php">
                 <i class='fas fa-lira-sign' style='font-size:18px;color:black'></i>Wire Transfer
            </a>
          </li>
