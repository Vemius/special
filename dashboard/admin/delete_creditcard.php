...
if(isset($_POST['btn-del']))
{
	$id = $_GET['delete_id'];
	$crud->deletecc($id);
	header("Location: delete_creditcard.php?deleted");	
}
...
if(isset($_GET['delete_id']))
{
    ...
    <a href="creditcards.php" class="btn btn-large btn-success"><i class="glyphicon glyphicon-backward"></i> &nbsp; NO</a>
    </form>  
	<?php
}
else
{
	?>
    <a href="creditcards.php" class="btn btn-large btn-success"><i class="glyphicon glyphicon-backward"></i> &nbsp; Back to index</a>
    <?php
}
?>
