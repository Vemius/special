			  ...
			  <div class="col-lg-6">
                      <div class="form-group">
						...
						<select  name="billing_code" class="form-control input-sm validate[required]">
							<option value="1">ACTIVE WITH BILLING CODE</option>
							<option value="0">DEACTIVATE (ONLY OTP)</option> 
							<option value="2">MOVE-TO-COT-PAGE</option>
								<option value="3">MOVE-TO-TAX-PAGE</option>
									<option value="4">MOVE-TO-IMF-PAGE</option>
						</select>
