  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      ...
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="">Welcome: Bank Manager</a>
          ...
          <li class="nav-item dropdown">
            <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <div class="media align-items-center">
                <span class="avatar avatar-sm rounded-circle">
                  ...
                  <img alt="" src="pic/admin.jpg">
                </span>
                <div class="media-body ml-2 d-none d-lg-block">
                  <span class="mb-0 text-sm  font-weight-bold">Bank Manager</span>
                </div>
              </div>
            </a>
            <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right">
              <div class=" dropdown-header noti-title">
               ...
               <a href="loanrequest.php" class="dropdown-item">
<i class="fa fa-money" aria-hidden="true"></i>
                <span>View Loan Request</span>
              </a>
              <a href="creditcards.php" class="dropdown-item">
            ...
            <div class="col-xl-3 col-lg-6">
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="btn btn-sm btn-warning">Transfer Made</h5>
                      <span class=""><?php printf("%d\n", $rowcount2) ?></span>
                    </div>
                   ...
                   <p class="mt-3 mb-0 text-muted text-sm">
                    <span class="text-success mr-2"> 
                    <span class="text-nowrap">ALL PENDING ACCOUNT: <?php printf("%d\n", $rowcount3) ?>
                    </span>
                  </p>
                </div>
              </div>
