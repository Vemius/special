...
if(isset($_POST['code'])){
	...
	if($sub !== $cot){
	   ...
	   $msg1 = "
					...
					<center><strong style='color:white;'>Congratulations!! Your COT Code has been Validated. Please Wait.... 
                           </strong></center>
			  		</div>
					";
	}
      ...
      <div class="row">
        <div class="col-lg-8 mx-auto">
          <div class="">
            ...
            <div class="card-body">
                <p><strong>Wire Transfer to:</strong> <?php echo $rows['bank_name']; ?></p>
          ...
          <div class="card bg-gradient-info ps-3">
              <div class="row align-items-center">
                <div class="col-8">
                  ...
                  <h5 class="text-white mb-0">One Time Passcode (OTP)</h5>
                </div>
                  ...
                  <?php if (isset($msg)) echo $msg; ?>
                    <div class="col-lg-6">
                      ...
                      <div class="form-group">
                        <label class="form-control-label text-sm" for="input-username">COT Code</label>
