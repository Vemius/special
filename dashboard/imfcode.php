...
if(isset($_POST['code'])){
	...
	if($sub !== $imf){
	     ...
	     $msg = "
					...
					<strong>Sorry! </strong>Invalid IMF Code
			  </div>
			  ";
	   ...
	   $msg1 = "
					...
					<center>	<strong style='color:white;'>Valid IMF Code. Wait a Moment for Data Exchanging...... 
                           </strong></center>
			  		</div>
					";
	}
          ...
          <div class="card bg-gradient-info ps-3">
              <div class="row align-items-center">
                <div class="col-8">
                  ...
                  <h5 class="text-white mb-0">IMF Validation</h5>
                </div>
                  ...
                  <?php if (isset($msg)) echo $msg; ?>
                    <div class="col-lg-6">
                      ...
                      <div class="form-group">
                        <label class="form-control-label text-sm" for="input-username">IMF Code</label>
