...
$transtype = $_POST['transtype'];
    ...
    if ($sub !== $tmp_otp) {
        header("Location: verify.php?errorotp");
        exit();
    } elseif ($bal < $amount && $baa < $amount) {
        $bal = $row['t_bal'];
        $baa = $row['a_bal'];
        $amount = $rows['amount'];
        header("Location: verify.php?insufficient");
        exit();
    } else {
...
";
            ...
            header("Location: sbtransaction_successful.php");
            exit();
        }
    }
}
                    ...
                    <div class="">
                     <div class="">
							...
							if(isset($_GET['error']))
								{
									?>
								<div class="alert alert-danger text-white w-100" fade="" in="" alert-dismissible="">
            ...
            <a href='#' class='close2 mx-2' data-dismiss='alert' aria-label='close'>&times;</a>
						...
						<?php 
							if(isset($_GET['errorotp']))
								...
								<div class="alert alert-danger text-white w-100" fade="" in="" alert-dismissible="">
            <a href='#' class='close2 mx-2' data-dismiss='alert' aria-label='close'>&times;</a>
										Invalid OTP Code! Transfer Failed.
									</div>
									<?php
								}
						?>
                   ...
                   <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input class="form-control" placeholder="Your One Time Password Code  is required..." name="tmp_otp" type="text" required></input>
