    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="mobile-list d-sm-none">
        ...
        <a href="make_transfers.php"><li><i class="fas fa-paper-plane  text-white"></i></li></a>
        <a href="virtual_card.php"><li><i class="fas fa-credit-card text-white"></i></li></a>
        <a href="myprofile.php"><li><i class="fas fa-cogs text-white"></i></li></a>
            ...
            <li class="nav-item dropdown pe-2 d-flex align-items-center">
              ...
              <ul class="dropdown-menu  dropdown-menu-end  px-2 py-3 me-sm-n4" aria-labelledby="dropdownMenuButton">
                <li class="mb-2">
                  ...
                  <a class="dropdown-item border-radius-md" href="message_view.php?subject=<?php echo $show['subject']; ?>">
