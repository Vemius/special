...
<img style="width: 220px;" src="../assets/img/brand/blue.png" alt="LOGO" data-default="placeholder" data-max-width="80" width="14%">
            ...
            <div class="collapse navbar-collapse" id="navigation">
              ...
              <ul class="navbar-nav d-lg-block d-none">
                <li class="nav-item">
                  <a href="dashboard/contactus.php" class="btn btn-sm btn-round mb-0 me-1 bg-gradient-dark">Contact Us</a>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              ...
              <form autocomplete="off" method="POST">
                  ...
                  <p class="mb-0">Personal & Coperate online sign-in</p>
...
/* ]]> */
                ...
                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                  <p class="mb-4 text-sm mx-auto">
                    ...
                    <a href="online_access/applyonline.php" class="text-info text-gradient font-weight-bold">Sign up</a>
                  </p>
                </div>
              </div>
            </div>
