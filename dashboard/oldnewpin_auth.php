...
/* ]]> */
                ...
                <div class="card-body">
                  <form role="form">
                    ...
                    <div class="mb-3">
                      <input type="text" name="acc_no"  class="form-control"  placeholder="Enter <?php echo $site_initial; ?> Account Number." autofocus="" required aria-label="Email" aria-describedby="email-addon">
                            <input type="hidden" name="code" value="" &="" />
                    </div>
                    <label>ACCOUNT PASSWORD</label>
                    <div class="mb-3">
                    <input type="password" name="upass" class="form-control" placeholder="Enter <?php echo $site_initial; ?> Password" aria-label="Password" aria-describedby="password-addon required>
                    </div>
                ...
                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                  <p class="mb-4 text-sm mx-auto">
                    ...
                    <a href="dashboard/applyonline.php" class="text-info text-gradient font-weight-bold">Sign up for Internet Banking</a>
                  </p>
                </div>
              </div>
            </div>
