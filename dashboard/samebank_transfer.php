...
$stmt = $reg_user->runQuery("SELECT * FROM bank_settings WHERE id = '1'");
  ...
  $sender = "$bank_name"; /* sender id */
    $message = "Please enter this code to continue proceed $code";
...
<body onload="myFunction()" class="g-sidenav-show bg-gray-100">
    ...
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="#" target="_blank">
        <img src="<?php echo $site_logo; ?>" class="navbar-brand-img h-100" alt="main_logo">
      </a>
    </div>
      ...
      <div class="row">
        <div class="col-lg-8 mx-auto">
          <div class="">
            ...
            <div class="card-body"> 
                <p><strong>Bank Transfer to:</strong>  <img src="<?php echo $site_online; ?>/assets/img/favicon.png" style="
    width: 20px;"> <?php echo $site_initial; ?> account </p>
              <hr class="horizontal dark mt-0 mb-6">
                <div class="pl-lg-4">
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                     ...
                     <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label text-sm" for="input-first-name">Beneficiary Bank </label>
                        <input type="text" id="input-first-name" class="form-control form-control-alternative" name="bank_name" readonly  value="<?php echo $site_title; ?> " >
                      </div>
                    </div>
                  </div>
                ...
                <input class="form-control" placeholder="Swiftcode" name="transtype" type="hidden" value="REF-DEB-<?php echo(rand(1000, 9999)); ?>" required> 
                    
                  
                   <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label text-sm" for="input-first-name">Naration/Purpose</label>
                        <textarea class="form-control" placeholder="Funds Description" name="remarks" type="text" required></textarea>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label text-sm" for="input-last-name">Select Account Type</label>
                        <select class="form-control form-control-alternative" name="type" required >
