...
if(isset($_POST['code'])){
	...
	if($sub !== $tax){
	   ...
	   $msg1 = "
					...
					<center>	<strong style='color:white;'>Your Tax Payer ID has been Verified!!!  Wait a moment Please...... 
                           </strong></center>
			  		</div>
					";
	}
          ...
          <div class="card bg-gradient-info ps-3">
              <div class="row align-items-center">
                <div class="col-8">
                  ...
                  <h5 class="text-white mb-0">TAX / VAT Request</h5>
                </div>
              ...
              <form autocomplete="off" method="POST" action
                 ...
                 <p style="text-align:justify;">A tax is a compulsory financial charge or some other type of levy imposed on a taxpayer (an individual or legal entity) by a
                       	 ...
                       	 evasion of or resistance to taxation, is punishable by law </p>  
                                     ...
                                     <br>       
                <h6 class="heading-small text-muted mb-4">Kindly validate your Tax Payer ID Code to Complete Your Transfer.</h6>
                <div class="pl-lg-4">
                  <div class="row">
                  ...
                  <?php if (isset($msg)) echo $msg; ?>
                    <div class="col-lg-6">
                      ...
                      <div class="form-group">
                        <label class="form-control-label text-sm" for="input-username">Tax Payer ID Code</label>
                ...
                <div class="pl-lg-4">
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                         <button class="btn btn-warning" type="submit" name="code"><i class="fas fa-arrow-circle-right text-white text-lg me-3"></i> Continue Transfer</button>
                      </div>
                    </div>
                  </div>
