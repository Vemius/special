...
<title>credit-card</title>
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
    ...
    <div class="container-fluid py-4">
      <div class="row">
        <div class="col-lg-7 mx-7">
          <div class="">
            <div class="card-header p-3 pb-0">
              <div class="d-flex justify-content-between align-items-center">
            <div class="card-body">
                <p><strong>Bank Transfer to:</strong>  <img src="../assets/img/favicon.png" style="
     ...
     <div class="col-xl-12">
          <div class="card bg-gradient-info ps-3">
              <div class="row align-items-center">
                <div class="col-8">
                  <h6 class="text-white mb-0">TRANSACTION CONFIRMATION</h6>
                </div>
          ...
          <center>  <img src="icon/check-circle.gif" style="height:80px; width:80px;  "/></center>  
          <br>
          <h4 class="text-success">Transfer successful</h4> 
         <p>You have successfully Transfered <?php echo $row['currency']?><?php echo $rows['amount']?></p>
         <p><b>To Account Number:</b> <?php echo $rows['acc_no']?></p> 
         <p><b>Beneficiary Name:</b> <?php echo $rows['acc_name']?></p>
         <p><b>Beneficiary Bank:</b> <?php echo $rows['bank_name']?></p>
          </br>
                        
            <a href="summary.php" class="btn btn-warning mx-auto">OKAY</a></center> 
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-gradient-success">
                <h5 class="modal-title mx-auto text-white">TRANSACTION CONFIRMATION</h5>
                <a type="button" class="close2" data-dismiss="modal">&times;</a>
            </div>
            <div class="modal-body">
                 <center> <i class="fas fa-check text-success fa-3x"></i>
          <br>
          <h5 style="color:#114e11;">You have successfully Transfered</h5>
          <h5 style="color:#114e11;">Amount: <?php echo $row['currency']?><?php echo $rows['amount']?></h5>
          <h5 style="color:#114e11;">To</h5>
          <h5 style="color:#114e11;">Beneficiary Name:&nbsp;&nbsp;<?php echo $rows['acc_name']?></h5>
          <h5 style="color:#114e11;">Beneficiary Bank:&nbsp;&nbsp;<?php echo $rows['bank_name']?></h5>
          <h5 style="color:#114e11;">Beneficiary Account No.:&nbsp;&nbsp;<?php echo $rows['acc_no']?></h5>
          
                <br>
                <p style="text-align:center;color:red;font-size: 15px;"><strong>PLEASE NOTE</strong></p>
                <p style="text-align:justify;color:red;font-size: 15px;">International transaction initiated successfully, </br>it will take 2-3 working days to credit funds in receivers account.<br>
A detail of this transaction has been sent to your email. <br>We recommend you contact the receiver of the fund to await  2-3 working days.</p>
<br>
                <form>
