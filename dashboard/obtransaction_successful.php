...
<body onload="myFunction()" class="g-sidenav-show bg-gray-100">
    ...
    width: 20px;"> <?php echo $site_initial; ?> account </span>
              ...
              <li class="nav-item active">
                <a class="nav-link active" href="other_transfer.php">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
          ...
          <h5 style="color:#114e11;">Beneficiary Account No.:&nbsp;&nbsp;<?php echo $rows['acc_no']?></h5>
                ...
                <br>
                <p style="text-align:center;color:red;font-size: 15px;"><strong>SECUTIRY TIPS</strong></p>
                <p style="text-align:justify;color:red;font-size: 15px;">Do not share your creditials with anyone.<br>We wll never ask you for your password, PIN or OTP codes. <br>Always report suspicious mails to fraud@domain.com</p>
<br>
                <form>
