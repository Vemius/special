<div class="container-scroller" >
      <nav class="sidebar sidebar-offcanvas" id="sidebar"  >
        <div class="text-center sidebar-brand-wrapper d-flex align-items-center" style="background-color:<?php echo $digital_forest_script_menu; ?>; color:<?php echo $digital_forest_script_menu_font; ?>;">
        ...
        <ul class="nav" style="background-color:<?php echo $digital_forest_script_menu; ?>; color:<?php echo $digital_forest_script_menu_font; ?>;">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="wire-transfer.php">Wire/Intl Transfer</a>
                </li>
              </ul>
            </div>
          </li>
